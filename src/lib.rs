...
//!
//! ## swapkit-rs
//! This is the Unofficial Rust bindings for `SwapKit`. It aims to provide a fully typed client for the `SwapKit` API.
//!
...
//!
//! The base URL is configurable and is never hardcoded into a call path. Two well-known instances
